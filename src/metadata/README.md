 ...
 * [t4fs.yml](t4fs.yml)
     * Determines how your purl.obolibrary.org/obo/t4fs/ redirects will be handled
     ...
     * Paste in the contents of [t4fs.yml](t4fs.yml)
 ...
 * [t4fs.md](t4fs.md)
     ...
     * Paste in the contents of [t4fs.md](t4fs.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
